...
const STRINGS = {
  en: {
    ...
    conf:               'conf.',
    taskType:           'Task type',
    taskTypeOpinion:    'Opinion/Position Essay',
    taskTypeLetter:     'Response to letters, memos, or emails',
  ...
  es: {
    ...
    taskTypeOpinion:    'Ensayo de opinión/postura',
    taskTypeLetter:     'Respuesta a cartas, memorandos o correos',
